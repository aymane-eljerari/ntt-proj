...
int main() {
  ...
  printf("Average Naive NTT Time      : %f ms\n", results.naive_time_ms);
  printf("Average Fast NTT Time       : %f ms\n", results.fast_time_ms);
  printf("Average Prod NTT Time       : %f ms\n", results.prod_time_ms);
  printf("Average GPU Radix-2 Time    : %f ms\n", results.gpu_radix2_time_ms);
  printf("Average GPU Radix-4 Time    : %f ms\n", results.gpu_radix4_time_ms);
